...
create.phylogenetic.tree(
    filename = 'figures/2A_sample-specfic-phylogeny.png',
    cp.dt,
    add.normal = TRUE,
    scale1 = 2,
    height = 7,
...
```{r echo=FALSE, out.width='50%'}
kable(cp.dt);
include_graphics('figures/2A_sample-specfic-phylogeny.png');
```

### Different tree modes

# Single-sample Phylogenetic Trees