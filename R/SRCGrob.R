SRCGrob <- function(
    ...
    yaxis1_label = "SNVs",
    yaxis2_label = NULL,
    axis_label_cex = list(x = 1.55, y = 1.55),
    axis_cex = list(x = 1.45, y = 1.45),
    yaxis1_interval = NA,
    yaxis2_interval = NA,
    ylimit = NULL,
    xaxis_label = NULL,
    ...
    clone.out <- make.clone.tree.grobs(
        ...
        wid = wid,
        line.lwd = line.lwd,
        length_from_node_edge = length_from_node_edge,
        seg1.col = seg1.col,
        seg2.col = seg2.col,
        ...
        xaxis_space_left = xaxis_space_left,
        xaxis_space_right = xaxis_space_right,
        min_width = min_width,
        nodes = nodes,
